...
public abstract class MySwipeHelper extends ItemTouchHelper.SimpleCallback {
    ...
    public class MyButton{
        private String text;
        private int imageReadI,textSize,color,pos;
        ...
        public MyButton( Context context,String text, int textSize, int imageReadI, int color, MyButtonClickListener listener) {
            this.text = text;
            this.imageReadI = imageReadI;
        ...
        public void onDraw(Canvas c , RectF rectF, int pos)
        {
            ...
            {
                Drawable d = ContextCompat.getDrawable(context,imageReadI);
